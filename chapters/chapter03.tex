...
\begin{document}
    ...
    \subsection{Coder+Sharelatex-Instanz}
    \urlslide[Coder-Instanz für die O-Fahrt(lokal, schnell)]{https://coder.ofahrt-d120.de}
    \urlslide[Sharelatex-Instanz der TU-Darmstadt(langsam)]{https://sharelatex01.ca.hrz.tu-darmstadt.de}
    \subsection{Übungsphase}
    \begin{frame}[c]
        \slidehead{}
        \centering
        15 Minuten Übungsphase
        \begin{columns}[c]
            \begin{column}{.5\textwidth}
                \begin{figure}
                    \centering
                    \qrcode[height=3cm]{https://sharelatex01.ca.hrz.tu-darmstadt.de}
                    \caption{Coder-Instanz für die O-Fahrt\\\url{https://coder.ofahrt-d120.de}}
                \end{figure}
            \end{column}%
            \begin{column}{.5\textwidth}
                \begin{figure}
